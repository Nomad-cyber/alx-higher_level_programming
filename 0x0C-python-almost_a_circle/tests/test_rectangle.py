...
class TestRectangle_instantiation(unittest.TestCase):
    ...
    def test_no_args(self):
        with self.assertRaises(l(7, Rectangle(10, 2, 0, 0, 7).id)
    ...
    def test_five_args(self):
        self.assertEquaint(Rectangle(5, 5, 0, 0, 1).__width)
...
class TestRectangle_update_kwargs(unittest.TestCase):
    ...
    def test_nan_height(self):
        with self.assertRaisesRegex(TypeError, "height must be an integer Rectangle(10, 2, 0, 0, 0)
        self.assertEqual(20, r.area())
...
class TestRectangle_stdout(unittest.TestCase):
    """Unittests for testing __str_      r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "x must be an integer"):
            r.update(x="invalid")
